 ...
 */
            ...
            /**
            *  GetResourceTypesResponse bean class
            */
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  java.lang.String[] getResourceType(){
                              ...
                              /**
                               * validate the array for ResourceType
                               */
                              protected void validateResourceType(java.lang.String[] param){
                             ...
                             */
                             public void addResourceType(java.lang.String param){
                                   if (localResourceType == null){
                                   localResourceType = new java.lang.String[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localResourceType);
                               list.add(param);
                               this.localResourceType =
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
               ...
               final org.apache.axiom.om.OMFactory factory) throws org.apache.axis2.databinding.ADBException{
                ...
                org.apache.axiom.om.OMDataSource dataSource =
                 ...
                 public void serialize(org.apache.axis2.databinding.utils.writer.MTOMAwareXMLStreamWriter xmlWriter) throws javax.xml.stream.XMLStreamException {
                       GetResourceTypesResponse.this.serialize(MY_QNAME,factory,xmlWriter);
                 }
               };
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetResourceTypesResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetResourceTypesResponse",
                ...
                if (localResourceTypeTracker){
                             if (localResourceType!=null) {
                                   ...
                                   for (int i = 0;i < localResourceType.length;i++){
                                        
                                            if (localResourceType[i] != null){
                                        
                                                if (!emptyNamespace) {
                                                    if (prefix == null) {
                                                        java.lang.String prefix2 = generatePrefix(namespace);

                                                        xmlWriter.writeStartElement(prefix2,"resourceType", namespace);
                                                    ...
                                                    xmlWriter.writeStartElement("resourceType");
                                                        ...
                                                        xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localResourceType[i]));
                                  ...
                                  for (int i = 0;i < localResourceType.length;i++){
                                         ...
                                         if (localResourceType[i] != null){
                                          elementList.add(new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws",
                                                                              "resourceType"));
                                          elementList.add(
                                          org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localResourceType[i]));
                                          } else {
    ...
    public static class Factory{
        ...
        */
        public static GetResourceTypesResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetResourceTypesResponse object =
                new GetResourceTypesResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetResourceTypesResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetResourceTypesResponse)edu.fiu.cis.acrl.virtuallabs.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","resourceType").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
                                            ...
                                            // call the converter utility  to convert and set the array
                                                    ...
                                                    object.setResourceType((java.lang.String[])
