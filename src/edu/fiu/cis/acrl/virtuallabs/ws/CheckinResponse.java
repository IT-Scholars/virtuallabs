        ...
        private static java.lang.String generatePrefix(java.lang.String namespace) {
            ...
            return org.apache.axis2.databinding.utils.BeanUtil.getUniquePrefix();
                        ...
                        */
                                    ...
                                    protected edu.fiu.cis.acrl.virtuallabs.ws.TodoType[] localTodo ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           * @return edu.fiu.cis.acrl.virtuallabs.ws.TodoType[]
                           */
                           public  edu.fiu.cis.acrl.virtuallabs.ws.TodoType[] getTodo(){
                               return localTodo;
                           }
                              ...
                              /**
                               * validate the array for Todo
                               */
                              protected void validateTodo(edu.fiu.cis.acrl.virtuallabs.ws.TodoType[] param){
                              ...
                              * @param param Todo
                              */
                              public void setTodo(edu.fiu.cis.acrl.virtuallabs.ws.TodoType[] param){
                             ...
                             * @param param edu.fiu.cis.acrl.virtuallabs.ws.TodoType
                             */
                             public void addTodo(edu.fiu.cis.acrl.virtuallabs.ws.TodoType param){
                                   if (localTodo == null){
                                   localTodo = new edu.fiu.cis.acrl.virtuallabs.ws.TodoType[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localTodo);
                               list.add(param);
                               this.localTodo =
                             (edu.fiu.cis.acrl.virtuallabs.ws.TodoType[])list.toArray(
                            new edu.fiu.cis.acrl.virtuallabs.ws.TodoType[list.size()]);
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                if (localTodoTracker){
                                       if (localTodo!=null){
                                            for (int i = 0;i < localTodo.length;i++){
                                                if (localTodo[i] != null){
                                                 localTodo[i].serialize(new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","todo"),
                                                           factory,xmlWriter);
                                                } else {
                                               ...
                                               throw new org.apache.axis2.databinding.ADBException("todo cannot be null!!");
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckinResponse".equals(type)){
                                ...
                                return (CheckinResponse)edu.fiu.cis.acrl.virtuallabs.ws.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","todo").equals(reader.getName())){
                                
                                    
                                    
                                    // Process the array and step past its final element's end.
                                    list1.add(edu.fiu.cis.acrl.virtuallabs.ws.TodoType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://acrl.cis.fiu.edu/virtuallabs/ws","todo").equals(reader.getName())){
                                                                    list1.add(edu.fiu.cis.acrl.virtuallabs.ws.TodoType.Factory.parse(reader));
                                                        ...
                                                        object.setTodo((edu.fiu.cis.acrl.virtuallabs.ws.TodoType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                edu.fiu.cis.acrl.virtuallabs.ws.TodoType.class,
                                                                list1));
