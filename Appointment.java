 ...
 */
        ...
        implements org.apache.axis2.databinding.ADBBean, Comparable {
        /* This type was generated from the piece of schema that had
                name = Appointment
                Namespace URI = http://virtuallabs.acrl.cis.fiu.edu
                Namespace Prefix = ns1x
                */
            

        private static java.lang.String generatePrefix(java.lang.String namespace) {
            if(namespace.equals("http://virtuallabs.acrl.cis.fiu.edu")){
                return "ns1";
            }
     ...
     /***
      * 
      * 	Compare to based on dates
      */
     public int compareTo(Object o) throws ClassCastException {
    	 
    	 Appointment app = (Appointment)o;
    	 if( this.localStart.equals(app.getStart()) && this.localEnd.equals(app.getEnd()))
    		 return 0;
        	
    	 
    	 if(this.localStart.before(app.getStart()) || this.localStart.equals(app.getStart()))
    	 {
        	 if(this.localEnd.before(app.getEnd()))
        	 {
        		 return -1;
     ...
     public String toString(){
    	 ...
    	 return "("+this.localAvailabilityStatus+") "+this.localStart.getTime()+" to "+this.localEnd.getTime()+" course "+this.localCourse+" resource "+this.localResourceType;
   ...
   public static boolean isReaderMTOMAware(javax.xml.stream.XMLStreamReader reader) {
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   java.lang.String namespacePrefix = registerPrefix(xmlWriter,"http://virtuallabs.acrl.cis.fiu.edu");
                                       ...
                                       if (localAction!=null){
                                            for (int i = 0;i < localAction.length;i++){
                                                if (localAction[i] != null){
                                                 localAction[i].serialize(new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","action"),
                                                           factory,xmlWriter);
                                                } else {
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu",
                                                                      "id"));
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list9 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","id").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","userName").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","start").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","end").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","resourceType").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","course").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","affiliationId").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","availabilityStatus").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","action").equals(reader.getName())){
                                    ...
                                    list9.add(Action.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone9){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://virtuallabs.acrl.cis.fiu.edu","action").equals(reader.getName())){
                                                                    list9.add(Action.Factory.parse(reader));
